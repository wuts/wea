...
(
	...
	'login_succeed' => '{$_G[member][username]}成功登录',
	'login_strike' => '累计5次密码错误,15分钟内不能登录',
	'login_invalid' => '用户名或密码有误,你共有5次尝试机会',
	'logout' => '退出',
	...
	'register_ctrl' => '对不起，你的 IP 地址在 {$_G[setting][regctrl]} 小时内只能注册一个帐号，请返回。',
	'register_flood_ctrl' => '对不起，同一 IP 地址在 24 小时内只能进行 {$_G[setting][regfloodctrl]} 次注册尝试，请返回。',
	'register_manual_verify' => '非常感谢你的注册，管理员设置了人工验证新注册用户，请等待审核通过，现在将转入控制面板首页。',
	'register_succeed' => '非常感谢你的注册，现在将以会员身份登录论坛。',
	'activation_disable' => '此论坛禁止通过WAP激活',
	'register_activation_message' => '对不起，你输入的用户名 \"$username\" 已经存在，请登录论坛激活此帐号<br /><a href=\"forum.php?mod=index&action=login\">登录论坛</a>',
	...
	'fav_existence' => '你过去已经收藏过这个主题或者版块，请返回。',
	...
	'post_message_toolong' => '内容超过{{$_G[setting][maxpostsize]}}字节限制',
	'post_message_tooshort' => '内容少于{{$_G[setting][minpostsize]}}字节限制',
	'post_type_isnull' => '未选择主题分类',
	'post_flood_ctrl' => '两次发表少于{{$_G[setting][floodctrl]}}秒',
	'post_mod_succeed' => '成功提交人工审核',
	'post_mod_forward' => '回到当前论坛',
	'post_thread_closed' => '本主题已关闭',
	'post_thread_closed_by_dateline' => '本主题发布于{$_G[forum][autoclose]}天前<br />已被自动关闭',
	'post_thread_closed_by_lastpost' => '本主题最后回复于{$_G[forum][autoclose]}天前<br />已被自动关闭',
	'post_newbie_span' => '注册{{$_G[setting][newbiespan]}}分钟后才可发帖',
	'post_hide_nopermission' => '无权使用[hide]代码',
	'post_newthread_nopermission' => '无权在本论坛发新话题',
	'post_newthread_succeed' => '主题发表成功<br /><a href=\"forum.php?mod=index&action=forum&amp;fid=$_G[fid]\">返回论坛</a>',
	'post_newthread_forward' => '查看主题',
	'post_newreply_nopermission' => '无权在本论坛发表回复',
	'post_newreply_succeed' => '主题回复成功<br /><a href=\"forum.php?mod=index&action=forum&amp;fid=$_G[fid]\">返回论坛</a>',
	...
	'profile_username_toolang' => '对不起，你的用户名超过 15 个字符，请返回输入一个较短的用户名。',
	'profile_username_tooshort' => '对不起，你输入的用户名小于3个字符, 请返回输入一个较长的用户名。',
	'profile_passwd_notmatch' => '两次输入的密码不一致，请返回检查后重试。',

	'profile_passwd_illegal' => '密码空或包含非法字符，请返回重新填写。',
	'profile_email_verify' => '确认 Email 已经发送，请用邮件中提供的方法激活你的帐号。如果你没有收到我们发送的系统邮件，请点击控制面板首页中的“重新验证 Email 有效性”，或尝试更换另外一个地址。注意：在完成激活之前，根据管理员设置，你将只能以等验证会员的身份访问论坛，你可能不能进行发帖等操作。激活成功后，上述限制将自动取消。',
	...
	'pm_flood_ctrl' => '两次发表少于{{$_G[setting][floodctrl]}}秒',
	...
	'search_ctrl' => '对不起，你在 {$_G[setting][searchctrl]} 秒内只能进行一次搜索，请返回。',
	'search_id_invalid' => '你指定的搜索不存在或已过期，请返回。',
	'search_group_nopermission' => '你所在的用户组没有搜索权限，请返回',
