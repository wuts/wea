...
$lang = array (
  ...
  'pay_balance' => '购买后余额',
  'price' => '售价',
  'status_download' => '你所在的用户组可以免费下载',
  'status_insufficient' => '你的 {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]} 不足，无法下载',
  ...
  'post_hide_credits_hidden' => '，本帖隐藏的内容需要积分高于 $creditsrequire 才可浏览，你当前积分为 {$_G[member][credits]}',
  'post_hide_reply_hidden' => '，如果你要查看本帖隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>',
  'upload' => '上传',
  ...
  'attachment_unit' => '个文件',
  'attachment_uploaded' => '以下是你上次上传但没有使用的附件:',
  'batch_upload' => '批量上传',
  'cancel' => '取消',
  'click_here' => '点击这里',
  'common_upload' => '普通上传',
  ...
  'normal_upload' => '普通上传',
  'post_credits_postattach' => '每上传一个附件你的',
  ...
  'uploading' => '上传中，请稍候，你可以<a href="javascript:;" onclick="hideMenu()">暂时关闭这个小窗口</a>，上传完成后你会收到通知。',
  'use' => '使用',
  ...
  'forum_favorite' => '收藏本版',
  'forum_modedby' => '版主',
  'forum_moderate_unhandled' => '<a href="home.php?mod=space&uid=$_G[uid]&do=thread&view=me&type=thread&from=&filter=aduit">你有 $threadmodcount 个主题正等待审核中，点击查看</a>',
  ...
  'forum_password_require' => '本版块需要密码，你必须在下面输入正确的密码才能浏览这个版块。',

  'forum_moderate' => '审核',
  'logout' => '退出',
  'mod_error_invalid' => '对不起，你无此权限。',
  'mod_notice' => '论坛管理员在“管理面版”中权限和超级版主基本相同，如果需要更多功能，请进入 <a href="admin.php?mod=forum" target="_blank"><u>管理中心</u></a> ',
  ...
  'mod_message_access_admin_invalid' => '管理员设置此用户某些权限为强制允许，你不能变更管理员的这些设置',
  'mod_message_access_nonexistence' => '当前没有特殊权限用户',
  'mod_message_access_updatepermission' => '用户权限更新成功, 请继续操作',
  'mod_message_access_user_invalid' => '对不起，你无权操作管理人员或特殊用户！',
  'mod_message_access_user_nonexistence' => '此用户不存在',
  'mod_moderate_selectforum' => '版块选择',
  'mod_notice_access' => '通常情况下，用户在版块的权限是根据他的用户组决定的，此处你可以限制某个用户在某版块的权限。<br />注意: 看帖是基本权限，一旦禁止, 其他权限会同时进行禁止。<br />图例说明: <img src="static/image/common/access_normal.gif" class="vm" /> 默认权限&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_disallow.gif" class="vm" /> 强制禁止&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_allow.gif" class="vm" />强制允许',
  'moderator' => '版主',
  'search' => '搜索',
  ...
  'invalidate' => '否决',
  'mod_message_moderate_nopermission' => '你没有管理任何版块的权限，无法执行此操作',
  ...
  'mod_moderate_nonexistence' => '你没有选择任何内容，请返回',
  ...
  'modcp_posts_error_1' => '搜索条件不足！你至少应当在 关键字，帖子作者或者发帖 IP 当中设置一个搜索的条件',
  'modcp_posts_error_2' => '时间范围错误！版主只能删除近 1 周的帖子，超级版主可以删除 2 周内的帖子，请重新选择开始时间',
  'modcp_posts_error_3' => '你输入的关键字不合法！每个关键字至少由 2 个汉字或者 4 个英文字符组成',
  'modcp_posts_error_4' => '你无权使用批量删帖功能',
  ...
  'post_message4' => '你在本版有',
  'post_message5' => '篇草稿',
  'post_message6' => '点击标题前的',
  'post_message7' => '可以直接引用该草稿内容',
  ...
  'post_click_message_1' => '点击更新来更换你的图片',
  'post_click_message_2' => '添加一张好看的图片，让活动更吸引人',
  'post_closing' => '报名截止',
  'post_error_message_1' => '对不起，请输入活动时间',
  'post_error_message_2' => '对不起，请输入活动地点',
  'post_error_message_3' => '对不起，请输入活动类别',
  ...
  'debate_umpire' => '裁判',
  'post_debate_message_1' => '对不起，请输入正方观点',
  'post_debate_message_2' => '对不起，请输入反方观点',
  ...
  'post_reward_error_message' => '对不起，请输入悬赏价格',
  ...
  'post_goods_error_message_1' => '对不起，请输入商品名称',
  'post_goods_error_message_2' => '对不起，请输入商品数量',
  'post_goods_error_message_3' => '对不起，请输入商品价格',
  ...
  'admin_bump' => '提升主题',
  'admin_close' => '关闭主题',
  'admin_delthread_confirm' => '你确认要 <strong>删除</strong> 选择的主题么?',
  'admin_delthread_nopermission' => '你没有删除此主题权限',
  'admin_digest_add' => '精华',
  ...
  'admin_threadsplit_restore' => '你确认要将此主题移除存档区吗？',
  'admin_unbanpost' => '解除',
  ...
  'trade_buy_crediterror' => '<font color="red">你的积分不足</font>',
  ...
  'trade_guest_alarm' => '你目前为游客，购买后你无法在本版块查看交易状态，请到支付网站查询。',
  'trade_nums' => '购买数量',
  ...
  'trade_update_stickmax' => '你最多可推荐的商品数:',

  'attach_nopermission' => '你所在的用户组无法下载或查看附件',
  'eccredit_buyerinfo' => '买家信用',
  'eccredit_sellerinfo' => '卖家信用',
  'on_line' => '在线',
  'pack_up' => '收起',
  'post_trade_buynumber' => '累计售出',
  'post_trade_support_tenpay' => '此商品支持财付通，你可以先验货后付款',
  ...
  'attach_nopermission_login' => '你需要<a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a>才可以下载或查看附件。没有帐号？<a href="member.php?mod={$_G[setting][regname]}" onclick="hideWindow(\'login\');showWindow(\'register\', this.href);return false;" title="注册帐号">{$_G[setting][reglinkname]}</a>',
  'has_expired' => '该信息已经过期',
  'have' => '已有',
  ...
  'poll_msg_allowvotepolled' => '你已经投过票，谢谢你的参与',
  'poll_msg_allowvotethread' => '该投票已经关闭或者过期，不能投票',
  'poll_msg_allwvoteusergroup' => '你所在的用户组没有投票权限',
